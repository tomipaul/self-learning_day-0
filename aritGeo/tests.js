(function(){
  ...
  const aritGeo = require('./library.js');

  describe("Determine the sequence of an array of numbers: ", function() {

    describe("Case for a wrong input", function() {

      it("should return an error message if input is not an array", function() {
        expect(aritGeo('wrong input!')).toBe("Function requires array input!");
      });
